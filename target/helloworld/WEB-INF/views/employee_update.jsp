...
<c:if test="${not empty admin}">
    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i>修改员工信息</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="${pageContext.request.contextPath}/admin/adminInfo">主页</a></li>
                        <li><i class="fa fa-laptop"></i>修改员工信息</li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="form-horizontal ">
                        <form action="${pageContext.request.contextPath}/employee/update" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="areaan" class="form-control" value="${employee.areaan}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label">职位</label>
                                <div class="col-sm-4">
                                    <input type="text" name="post" class="form-control" value="${employee.post}">
                                </div>
                            </div>
