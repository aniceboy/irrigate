...
<c:if test="${not empty admin}">
    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i>修改区域信息</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="${pageContext.request.contextPath}/admin/adminInfo">主页</a></li>
                        <li><i class="fa fa-laptop"></i>修改区域信息</li>
                    </ol>
                </div>
            </div>
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form-horizontal ">
                        <form action="${pageContext.request.contextPath}/area/admin/update" method="post">
                            ...
                            <div class="form-group">
                                <label class="col-sm-1 control-label">区域地址</label>
                                <div class="col-sm-4">
                                    <input type="text" name="location" class="form-control" value="${area.location}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label">区域数量</label>
                                <div class="col-sm-4">
                                    <input type="text" name="number" class="form-control" value="${area.number}">
                                </div>
                            </div>
