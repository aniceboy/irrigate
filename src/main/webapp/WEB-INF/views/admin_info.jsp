                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="panel-actions">
                                <a href="${pageContext.request.contextPath}/admin/adminInfo#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
                                <a href="${pageContext.request.contextPath}/admin/adminInfo#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
                                <a href="${pageContext.request.contextPath}/admin/adminInfo#" class="btn-close"><i class="fa fa-times"></i></a>
                            </div>
                        </div>
