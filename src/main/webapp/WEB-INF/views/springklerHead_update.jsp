                    ...
                    <div class="form-horizontal ">
                        <form action="${pageContext.request.contextPath}/springklerHead/update" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="location" class="form-control" value="${springklerHead.location}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label">安装时间</label>
                                <div class="col-sm-4">
                                    <input type="text" name="installtime" class="form-control" value="${springklerHead.installtime}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label">工作状态</label>
                                <div class="col-sm-4">
                                    <input type="text" name="state" class="form-control" value="${springklerHead.state}">
                                </div>
                            </div>
