...
<c:if test="${not empty admin}">
    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i>查看员工信息</h3>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-home"></i><a href="${pageContext.request.contextPath}/admin/adminInfo">主页</a></li>
                        <li><i class="fa fa-laptop"></i>查看员工信息</li>
                    </ol>
                </div>
            </div>
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form-horizontal ">
                        <form action="${pageContext.request.contextPath}/employee/to_add" method="post">
                            <div class="row">
